...
from src.api.v1 import auth, backdoor, paypal, user, img, common, collect, pay, community
...
class RouterManager:
    ...
    def register_routers(app: FastAPI) -> None:
        ...
        try:
            ...
            app.include_router(
                community.router,
                prefix=f"{settings.api.v1_str}/community",
                tags=["community"]
            )
            logger.info("Registered community router")
