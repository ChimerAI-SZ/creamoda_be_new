...
class GenImgType(Enum):
    ...
    VARY_STYLE_IMAGE = GenImgTypeConstant(2, 11, "图片风格变换", "design, image to image, vary style image")
    ...
    VIRTUAL_TRY_ON_MANUAL = GenImgTypeConstant(3, 3, "虚拟试穿手动版", "design, virtual try on, manual")
    ...
    EXTEND_IMAGE = GenImgTypeConstant(4, 9, "扩图", "design, magic kit, extend image")
